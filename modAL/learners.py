...
class Committee(BaseCommittee):
    ...
    def _set_classes(self, given_classes):
        """
        ...
        print("\nconcat", np.concatenate(known_classes))
        print("\nnp unique {}\n".format(np.unique(np.concatenate(known_classes))))

        if given_classes.size == 0: # if class definitions are given
            put_together = np.concatenate(known_classes)
        
            print("\nknown_classes", known_classes)
            print("\nconcat", put_together)
            print("\nnp unique {}\n".format(np.unique(put_together)))
